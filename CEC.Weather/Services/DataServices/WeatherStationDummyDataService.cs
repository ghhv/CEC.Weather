...
namespace CEC.Weather.Services
{
    public class WeatherStationDummyDataService : 
        BaseDataService<DbWeatherStation, WeatherForecastDbContext>, 
        IDataService<DbWeatherStation, WeatherForecastDbContext>
    {
        ...
        public WeatherStationDummyDataService(IConfiguration configuration) : base(configuration)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public Task<int> GetRecordListCountAsync() => Task.FromResult(this.Records.Count);

        /// <summary>
        /// Inherited IDataService Method
        /// </summary>
        /// <returns></returns>
        public Task<List<DbWeatherStation>> GetFilteredRecordListAsync(IFilterList filterList)
        {
            var firstrun = true;
            // Get a empty list
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public Task<DbWeatherStation> GetRecordAsync(int id) => Task.FromResult(this.Records.FirstOrDefault(item => item.ID == id));
        ...
        /// <returns></returns>
        public async Task<DbTaskResult> UpdateRecordAsync(DbWeatherStation record)
        {
        ...
        /// <param name="record"></param>
        /// <returns></returns>
        public Task<DbTaskResult> CreateRecordAsync(DbWeatherStation record)
        {
        ...
        /// <returns></returns>
        public Task<List<string>> GetDistinctListAsync(DbDistinctRequest req)
        {
